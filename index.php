    ...
    <div class="about-container">
        ...
        <div class="about-text">
            ...
            <P>Compare The Biggest Car Rental Brands & Book Online in a Few Simple Steps. Unbeatable Prices. We Speak
             ...
             <p> povideing leading bespoke car rental software development companies, providing customize car rental websites with online booking solution throughout the globe. Simplifying the car rental business with fully functional booking engine and easy to use car rental booking websites best match to the individual car hire companies, tour & taxi perators.

ride& drive provides efficient car rental solution and dynamic car rental websites for car hire companies as per their exact requirement and specifications to make their car rental business more interactive and easy to manage online..</p>
...
<section class="reviews" id="reviews">
   ...
   $sql = "INSERT INTO `feedback` (`name`, `feedback`) VALUES ( '". $_POST['name'] ."', '". $_POST['feedback'] ."')";
    $res = mysqli_query($conn, $sql);
if(!$res){
...
?>
         ...
         <h1 class="text"> Enter your feedback </h1>
        <form  action="" method="post">
            <br>
            <br>
            <div >
                <input type="text"  name="name" placeholder="enter your name " class="select-form-text" required>
            </div>
            <div>
                <textarea cols="30" rows="9" name="feedback" placeholder="enter your idea" class="select-form-text" required></textarea>
        </div>
            <div>
